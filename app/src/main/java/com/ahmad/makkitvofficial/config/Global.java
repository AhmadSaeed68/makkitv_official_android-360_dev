package com.ahmad.makkitvofficial.config;
...
public class Global {
    public static final String API_URL = "https://makkitvoffical.makkitv.com/api/";
    ...
    public static final String SUBSCRIPTION_ID = "makkitvofficial";

    public static  final String appLovinBanner = "34c87329487be526";
    public static  final String appLovinInterstitial = "9600fc071dcabedd";
